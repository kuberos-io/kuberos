...
class Deployment(UserRelatedBaseModel):
    ...
    @property
    def ros_middleware(self):
        return self.deployment_manifest['metadata'].get('rmwImplementation', 'fastdds')
...
class DeploymentJob(models.Model):
    ...
    def get_reserved_ips(self) -> list:
        return self.ip_reserved
